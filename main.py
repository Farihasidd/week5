...
def upload():
   ImagePath=easygui.fileopenbox(msg="Choose a file", default=r"C:\Users\hp\PycharmProjects\cartoonEffect\*.jpg")
...
def cartoonify(ImagePath):
    ...
    save1.configure(background="pink",foreground="yellow",font=('arial',20,'bold'))
...
a = Button(root, text="Conversion of image",command=upload,padx=15,pady=10)
